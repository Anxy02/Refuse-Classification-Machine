// Generated by gencpp from file yolo_new/arm_init_position.msg
// DO NOT EDIT!


#ifndef YOLO_NEW_MESSAGE_ARM_INIT_POSITION_H
#define YOLO_NEW_MESSAGE_ARM_INIT_POSITION_H
...
struct arm_init_position_
{
  ...
  typedef boost::shared_ptr< ::yolo_new::arm_init_position_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::yolo_new::arm_init_position_<ContainerAllocator> const> ConstPtr;

}; // struct arm_init_position_

typedef ::yolo_new::arm_init_position_<std::allocator<void> > arm_init_position;

typedef boost::shared_ptr< ::yolo_new::arm_init_position > arm_init_positionPtr;
typedef boost::shared_ptr< ::yolo_new::arm_init_position const> arm_init_positionConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::yolo_new::arm_init_position_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::yolo_new::arm_init_position_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::yolo_new::arm_init_position_<ContainerAllocator1> & lhs, const ::yolo_new::arm_init_position_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::yolo_new::arm_init_position_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::yolo_new::arm_init_position_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::yolo_new::arm_init_position_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::yolo_new::arm_init_position_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::yolo_new::arm_init_position_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::yolo_new::arm_init_position_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::yolo_new::arm_init_position_<ContainerAllocator> >
{
  ...
  static const char* value(const ::yolo_new::arm_init_position_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x214a3a640e2cbc2dULL;
  static const uint64_t static_value2 = 0xaa6f74f00b9c277bULL;
};

template<class ContainerAllocator>
struct DataType< ::yolo_new::arm_init_position_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::yolo_new::arm_init_position_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::yolo_new::arm_init_position_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::yolo_new::arm_init_position_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::yolo_new::arm_init_position_<ContainerAllocator>& v)
  {
...
#endif // YOLO_NEW_MESSAGE_ARM_INIT_POSITION_H
