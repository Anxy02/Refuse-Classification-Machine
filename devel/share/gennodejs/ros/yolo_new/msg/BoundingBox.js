...
class BoundingBox {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = _serializer.int64(obj.xmid, buffer, bufferOffset);
    // Serialize message field [ymid]
    bufferOffset = _serializer.int64(obj.ymid, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.xmid = _deserializer.int64(buffer, bufferOffset);
    // Deserialize message field [ymid]
    data.ymid = _deserializer.int64(buffer, bufferOffset);
    return data;
  }
