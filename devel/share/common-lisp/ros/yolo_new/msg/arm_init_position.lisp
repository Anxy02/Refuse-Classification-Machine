...
(cl:defmethod cl:initialize-instance :after ((m <arm_init_position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'arm_init_position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolo_new-msg:<arm_init_position> is deprecated: use yolo_new-msg:arm_init_position instead.")))

(cl:ensure-generic-function 'init_joint1-val :lambda-list '(m))
(cl:defmethod init_joint1-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:init_joint1-val is deprecated.  Use yolo_new-msg:init_joint1 instead.")
  (init_joint1 m))

(cl:ensure-generic-function 'init_joint2-val :lambda-list '(m))
(cl:defmethod init_joint2-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:init_joint2-val is deprecated.  Use yolo_new-msg:init_joint2 instead.")
  (init_joint2 m))

(cl:ensure-generic-function 'init_joint3-val :lambda-list '(m))
(cl:defmethod init_joint3-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:init_joint3-val is deprecated.  Use yolo_new-msg:init_joint3 instead.")
  (init_joint3 m))

(cl:ensure-generic-function 'init_joint4-val :lambda-list '(m))
(cl:defmethod init_joint4-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:init_joint4-val is deprecated.  Use yolo_new-msg:init_joint4 instead.")
  (init_joint4 m))

(cl:ensure-generic-function 'init_joint5-val :lambda-list '(m))
(cl:defmethod init_joint5-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:init_joint5-val is deprecated.  Use yolo_new-msg:init_joint5 instead.")
  (init_joint5 m))

(cl:ensure-generic-function 'init_joint6-val :lambda-list '(m))
(cl:defmethod init_joint6-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:init_joint6-val is deprecated.  Use yolo_new-msg:init_joint6 instead.")
  (init_joint6 m))

(cl:ensure-generic-function 'save_init_pose-val :lambda-list '(m))
(cl:defmethod save_init_pose-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:save_init_pose-val is deprecated.  Use yolo_new-msg:save_init_pose instead.")
  (save_init_pose m))

(cl:ensure-generic-function 'arm_look-val :lambda-list '(m))
(cl:defmethod arm_look-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:arm_look-val is deprecated.  Use yolo_new-msg:arm_look instead.")
  (arm_look m))

(cl:ensure-generic-function 'arm_home-val :lambda-list '(m))
(cl:defmethod arm_home-val ((m <arm_init_position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolo_new-msg:arm_home-val is deprecated.  Use yolo_new-msg:arm_home instead.")
  (arm_home m))
