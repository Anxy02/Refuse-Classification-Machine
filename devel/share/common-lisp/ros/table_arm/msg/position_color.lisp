...
(cl:defmethod cl:initialize-instance :after ((m <position_color>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'position_color)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name table_arm-msg:<position_color> is deprecated: use table_arm-msg:position_color instead.")))

(cl:ensure-generic-function 'angleX-val :lambda-list '(m))
(cl:defmethod angleX-val ((m <position_color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader table_arm-msg:angleX-val is deprecated.  Use table_arm-msg:angleX instead.")
  (angleX m))

(cl:ensure-generic-function 'angleY-val :lambda-list '(m))
(cl:defmethod angleY-val ((m <position_color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader table_arm-msg:angleY-val is deprecated.  Use table_arm-msg:angleY instead.")
  (angleY m))

(cl:ensure-generic-function 'rotation-val :lambda-list '(m))
(cl:defmethod rotation-val ((m <position_color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader table_arm-msg:rotation-val is deprecated.  Use table_arm-msg:rotation instead.")
  (rotation m))

(cl:ensure-generic-function 'count-val :lambda-list '(m))
(cl:defmethod count-val ((m <position_color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader table_arm-msg:count-val is deprecated.  Use table_arm-msg:count instead.")
  (count m))
