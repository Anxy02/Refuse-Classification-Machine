...
if("TRUE" STREQUAL "TRUE")
  set(xf_mic_asr_offline_SOURCE_PREFIX /home/moyu/wheeltec_arm/src/xf_mic_asr_offline)
  set(xf_mic_asr_offline_DEVEL_PREFIX /home/moyu/wheeltec_arm/devel)
  ...
  set(xf_mic_asr_offline_INSTALL_PREFIX /home/moyu/wheeltec_arm/install)
...
if(NOT "/home/moyu/wheeltec_arm/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'xf_mic_asr_offline' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/moyu/wheeltec_arm/src/xf_mic_asr_offline/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/moyu/wheeltec_arm/devel/lib;/home/moyu/ros_yolov5/devel/lib;/opt/ros/noetic/lib)
